...
<main id="main">
  ...
  <section id="services" class="services">
    <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
            <h2>Aktivitas</h2>
            <p>Aktivitas Santri Selama TPQ Baiti Jannati</p>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6 order-2 order-lg-1">
                ...
                <div class="icon-box mt-5 mt-lg-0" data-aos="fade-up">
                    <a href="/aktivitas/santri-absensi" style="text-decoration: none; color: inherit;">
                        <i class="fas fa-calendar-check" style="font-size: 36px; color: #7cc576;"></i>
                        <h4 style="margin-top: 20px;">Absensi</h4>
                        <p>Pemantauan kehadiran santri secara berkala.</p>
                    </a>
                </div>

                <!-- Nilai -->
                <div class="icon-box mt-5" data-aos="fade-up" data-aos-delay="200">
                    <a href="/aktivitas/santi-nilai" style="text-decoration: none; color: inherit;">
                        <i class="fas fa-chart-line" style="font-size: 36px; color: #7cc576;"></i>
                        <h4 style="margin-top: 20px;">Nilai</h4>
                ...
                <div class="icon-box mt-5" data-aos="fade-up" data-aos-delay="100">
                    <a href="/aktivitas/santri-hafalan" style="text-decoration: none; color: inherit;">
                        <i class="fas fa-book-open" style="font-size: 36px; color: #7cc576;"></i>
                        <h4 style="margin-top: 20px;">Hafalan</h4>
                        <p>Progres hafalan surah yang dicapai oleh santri.</p>
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-8 mt-5 mt-lg-0">
          <form action="/contact/send" method="post" role="form" class="p-4 bg-white rounded"
            data-aos="fade-left">
            @csrf
            <div class="row">
