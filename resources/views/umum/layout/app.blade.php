...
<body>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-3 text-right d-flex align-items-center justify-content-end">
                    <a href="/login" class="small mr-3" style="color: #51be78 !important;"><span
                            class="fas fa-unlock-alt"></span> Log In</a>
                    <a href="/daftar" class="small btn px-4 py-2 rounded-0"
                        style="background-color: #51be78; color: #ffffff !important;"><span
                            class="fas fa-file-alt"></span>
                        Daftar</a>
                </div>
            </div>
        </div>
    ...
    <header id="header" class="d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
            <div class="logo">
                <a href="/"><img src="{{ asset('assets/img/Logo.png') }}" alt="" class="img-fluid logo-img"></a>
            </div>


            <nav id="navbar" class="navbar">
                <ul class="nav">
                    <li class="nav-item"><a class="nav-link scrollto" href="/tpq-baitijannati#about">Home</a></li>
                    <li class="nav-item">
                        <a class="nav-link scrollto {{ request()->is('/tpq-baitijannati#pricing') || request()->is('kegiatan-tpq*') ? 'active' : '' }}"
                            href="/tpq-baitijannati#pricing">Program</a>
                    </li>
                    <li class="nav-item"><a class="nav-link scrollto" href="/tpq-baitijannati#portfolio">Galeri</a></li>
                    <li class="nav-item"><a class="nav-link scrollto" href="/tpq-baitijannati#contact">Contact</a></li>
                </ul>
